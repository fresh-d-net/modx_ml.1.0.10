...
**Внимание!** Чтобы закрыть доступ к директории шаблонов состороны клиента в /assets/templates помещен файл со след. содержанием:
```
deny from all
```
...
/assets/js/core.js - ядро реализующие декларативный стиль для jQuery библиотеки
...
**Внимание!** Путьуказывается относительно директории /assets/snippets/

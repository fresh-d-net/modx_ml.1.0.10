...
$c['emailsender'] = "frodo@fresh-d.net";
...
$c['editor_css_path'] = "/assets/css/styles.css";
...
$c['tinymce_custom_plugins'] = "style,advimage,advlink,searchreplace,print,contextmenu,paste,fullscreen,nonbreaking,xhtmlxtras,visualchars,media,table";
$c['tinymce_custom_buttons1'] = "undo,redo,selectall,separator,pastetext,pasteword,separator,search,replace,separator,nonbreaking,hr,charmap,separator,image,link,unlink,anchor,media,table,separator,cleanup,removeformat,separator,fullscreen,print,code,help";
...
$m = &$this->documentMap;
$d['ru/'] = 1;
$a[1] = array('id' => 1, 'alias' => 'ru/', 'path' => '', 'parent' => 0, 'isfolder' => 1);
$m[] = array('0' => '1');
$d['ru/index.html'] = 2;
$a[2] = array('id' => 2, 'alias' => 'index.html', 'path' => 'ru', 'parent' => 1, 'isfolder' => 0);
$m[] = array('1' => '2');
$c = &$this->contentTypes;
$c = &$this->chunkCache;
$s = &$this->snippetCache;
$s['Breadcrumbs'] = 'return include MODX_BASE_PATH . \'assets/snippets/Breadcrumbs.snippet.php\';';
$s['getBlog'] = 'return include MODX_BASE_PATH . \'assets/snippets/getBlog.snippet.php\';';
$s['TagsToTv'] = 'return include MODX_BASE_PATH . \'assets/snippets/tags/TagsToTv.snippet.php\';';
$s['getTags'] = 'return include MODX_BASE_PATH . \'assets/snippets/tags/getTags.snippet.php\';';
$s['getTagsCloud'] = 'return include MODX_BASE_PATH . \'assets/snippets/tags/getTagsCloud.snippet.php\';';
$s['getTagsForDocument'] = 'return include MODX_BASE_PATH . \'assets/snippets/tags/getTagsForDocument.snppet.php\';';
$s['getProductGallery'] = 'return include MODX_BASE_PATH . \'assets/snippets/catalogue/getProductGallery.snippet.php\';';
$s['getShopGoods'] = 'return include MODX_BASE_PATH . \'assets/snippets/getShopGoods.snippet.php\';';
$s['getGallery'] = 'return include MODX_BASE_PATH . \'assets/snippets/getGallery.snippet.php\';';
$s['EasyNewsLetter'] = 'return include MODX_BASE_PATH . \'assets/snippets/EasyNewsLetter.snippet.php\';';
...
/*
  Added fedo
*/
if(isset($topLevel) && !isset($startId)){
  $startId = $modx->runSnippet(\'UltimateParent\', array(\'topLevel\'=>$topLevel));
}
/*
  End
*/
...
return $output;';
$s['feedback'] = 'return include MODX_BASE_PATH . \'assets/snippets/feedback.snippet.php\';';
$s['LastChildRedirect'] = '
/*
 * @name FirstChildRedirect
 * @author Jason Coward <jason@opengeek.com>
...
$children= $modx->getActiveChildren($docid, \'menuindex\', \'ASC\');
if (!$children === false) {
    $firstChild= $children[count($children)-1];
    $firstChildUrl= $modx->makeUrl($firstChild[\'id\']);
} else {
    $firstChildUrl= $modx->makeUrl($modx->config[\'site_start\']);
}
return $modx->sendRedirect($firstChildUrl,0,\'REDIRECT_HEADER\',\'HTTP/1.1 301 Moved Permanently\');
';
$s['getDocField'] = 'return include MODX_BASE_PATH . \'assets/snippets/getDocField.snippet.php\';';
$s['getPublications'] = 'return include MODX_BASE_PATH . \'assets/snippets/getPublications.snippet.php\';';
$s['getTextDate'] = '
$i_id = isset($id) ? $id : $modx->documentIdentifier;
$s_scheme = isset($scheme) ? $scheme : \'%d %m %Y\';
if($i_id && empty($time)){
	$a_field_res = $modx->getDocument($i_id, \'createdon, pub_date\');
	$time = !empty($a_field_res[\'pub_date\']) ? $a_field_res[\'pub_date\'] : $a_field_res[\'createdon\'];
}

return ModExt::getTextDate($time, $s_scheme);
';
$s['order'] = 'return include MODX_BASE_PATH . \'assets/snippets/order.snippet.php\';';
$p = &$this->pluginCache;
...
include_once(MODX_BASE_PATH.\'assets/plugins/MultiFilesTv.plugin.php\');';
$p['MupltiFilesTvProps'] = '&tvIds=TV Ids;text;2 &templ=Template;text; &role=Role;text; &resize=Resize: enable;list;true,false;false &crop=Resize: cropping;list;true,false;true &prefix=Resize: prefix;text;s_ &th_width=Resize: width;text; &th_height=Resize: height;text; &auto_big=Resize: auto big img;list;true,false;false &auto_small=Resize: auto small img;list;true,false;false &w=Preview: width;text; &h=Preview: height;text; &thumbUrl=PHPThumb URL;text; ';
$p['SnippetFileSource'] = '/**
 * @name FileSource
 * @version 0.1
 *
 ...
 *  - OnSnipFormPrerender
 */
include(MODX_BASE_PATH . \'assets/plugins/SnippetFileSource.plugin.php\');';
$p['File Source Template'] = '//<?php
/**
...
include_once(MODX_BASE_PATH . \'assets/plugins/fileSouceTemplate.plugin.php\');';
$p['ClearImageCache'] = '//<?
...
include_once(MODX_BASE_PATH.\'assets/plugins/MupltiImagesTv.plugin.php\');';
$p['MupltiImagesTvProps'] = '&tvIds=TV Ids;text;1,13 &templ=Template;text; &role=Role;text; &resize=Resize: enable;list;true,false;false &crop=Resize: cropping;list;true,false;true &prefix=Resize: prefix;text;s_ &th_width=Resize: width;text; &th_height=Resize: height;text; &auto_big=Resize: auto big img;list;true,false;false &auto_small=Resize: auto small img;list;true,false;false &w=Preview: width;text; &h=Preview: height;text; &thumbUrl=PHPThumb URL;text; ';
$p['Settings'] = '//<?php
/**
* OnSiteSettingsRender - event
* &settings=Settings;textarea; label ~settings_name||label_1 ~settings_name_1
*/
include_once(MODX_BASE_PATH . "assets/plugins/settings.plugin.php");';
$p['SettingsProps'] = '&settings=Settings;textarea;Настройка пользователя (см. плагин Settings) ~some_set ';
$e = &$this->pluginEvent;
$e['OnBeforeDocFormSave'] = array('MupltiFilesTv','MupltiImagesTv');
$e['OnBeforeManagerLogin'] = array('Forgot Manager Login');
$e['OnBeforeSnipFormSave'] = array('SnippetFileSource');
$e['OnCacheUpdate'] = array('ClearImageCache');
$e['OnDocFormPrerender'] = array('ManagerManager');
$e['OnDocFormRender'] = array('ManagerManager','AlwaysStay','MupltiFilesTv','MupltiImagesTv');
...
$e['OnParseDocument'] = array('File Source Template');
...
$e['OnSiteSettingsRender'] = array('Settings');
$e['OnSnipFormPrerender'] = array('SnippetFileSource');
$e['OnSnipFormRender'] = array('AlwaysStay','SnippetFileSource');
$e['OnStripAlias'] = array('TransAlias');
$e['OnTempFormRender'] = array('AlwaysStay');
$e['OnTVFormRender'] = array('ManagerManager');
$e['OnWebPagePrerender'] = array('Search Highlight');

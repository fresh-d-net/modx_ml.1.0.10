...
$lang['url']='Название:';
$lang['link']='Большая картинка или ID видео на youtube:';
$lang['title']='Название:';
...
var MultiPhotos = new Class({
	...
	addItem: function(values,elem){
		...
		rowDiv.adopt(this.sp('{$lang['url']}'),this.br(),imgURL,this.br(),this.sp('{$lang['link']}'),this.br(),linkURL,bInsertLink,this.br(),bAdd);
